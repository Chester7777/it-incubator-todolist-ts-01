...
import {AddTodoListAC, ChangeFilterAC, ChangeTitleAC, RemoveTodoListAC, todoListReducer} from "./reducers/tl-reducer";
import {
    addTaskAC,
    changeTaskStatusAC,
    changeTaskTitleAC,
    removeTaskAC,
    tasksReducer
} from "./reducers/state/tasks-reducer";
...
// function for todoLists:
    ...
    function changeTodolistTitle(todolistId: string, newTodolistTitle: string) {
        ...
        //     setTodoLists([...todoLists])
        // }
        dispatchToTodoLists(ChangeTitleAC(todolistId, newTodolistTitle))
    }
